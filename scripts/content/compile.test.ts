    ...
    async () => {
      ...
      expect(javaScriptEntry).toMatchObject({
        ...
        lessonStarts: [
          ...
          {
            lessonId: 'javascript-ch04-l01',
            target: { kind: 'slide', targetId: 'javascript-ch04-l01-s01' },
          },
          {
            lessonId: 'javascript-ch04-l02',
            target: { kind: 'slide', targetId: 'javascript-ch04-l02-s01' },
          },
          {
            lessonId: 'javascript-ch04-l03',
            target: { kind: 'slide', targetId: 'javascript-ch04-l03-s01' },
          },
          {
            lessonId: 'javascript-ch04-l04',
            target: { kind: 'slide', targetId: 'javascript-ch04-l04-s01' },
          },
          {
            lessonId: 'javascript-ch04-l05',
            target: { kind: 'slide', targetId: 'javascript-ch04-l05-s01' },
          },
          {
            lessonId: 'javascript-ch05-l01',
            target: { kind: 'slide', targetId: 'javascript-ch05-l01-s01' },
          },
          {
            lessonId: 'javascript-ch05-l02',
            target: { kind: 'slide', targetId: 'javascript-ch05-l02-s01' },
          },
          {
            lessonId: 'javascript-ch05-l03',
            target: { kind: 'slide', targetId: 'javascript-ch05-l03-s01' },
          },
          {
            lessonId: 'javascript-ch05-l04',
            target: { kind: 'slide', targetId: 'javascript-ch05-l04-s01' },
          },
          {
            lessonId: 'javascript-ch06-l01',
            target: { kind: 'slide', targetId: 'javascript-ch06-l01-s01' },
          },
          {
            lessonId: 'javascript-ch06-l02',
            target: { kind: 'slide', targetId: 'javascript-ch06-l02-s01' },
          },
          {
            lessonId: 'javascript-ch06-l03',
            target: { kind: 'slide', targetId: 'javascript-ch06-l03-s01' },
          },
          {
